...
(function () {
  ...
  function authShell(title, sub, body) {
    return `<div class="login-screen"><div class="login-card">
      ...
      ${body}
      ${CFG.supportPhone ? `<p class="login-support"><a href="tel:${esc(CFG.supportPhone)}">Can't sign in? Contact support<span class="support-number">${esc(CFG.supportPhoneLabel || CFG.supportPhone)}</span></a></p>` : ""}
    </div></div>`;
  }
